    ...
    <div className="terms-container">
      ...
      <div className="terms-content">
        ...
        <p className="section-text">
          ...
          <span className="company-name">Sant Designers</span>. Throughout the
          site, the terms <span className="term-highlight">"we"</span>,
          <span className="term-highlight">"us"</span> and{" "}
          <span className="term-highlight">"our"</span>
          refer to <span className="company-name">Sant Designers</span>.<br />
          <span className="company-name">Sant Designers</span> offers this
        ...
        <p className="section-text">
          ...
          in our <span className="term-highlight">"Service"</span>and agree to
          be bound by the following terms and conditions ({" "}
          <span className="term-highlight">"Terms of Service"</span>,{" "}
          <span className="term-highlight">"Terms"</span>), including those
        ...
        <h2 className="section-title">SECTION 1 - ONLINE STORE TERMS</h2>
        <p className="section-text">
        ...
        <h2 className="section-title">SECTION 2 - GENERAL CONDITIONS</h2>
        <p className="section-text">
          ...
          <br /> The headings used in this agreement are included for
        ...
        <p className="section-text">
          ...
          accurate. <br />
          <br /> We reserve the right, but are not obligated, to limit the sales
          ...
          prohibited. <br /> <br /> We do not warrant that the quality of any
        ...
        <p className="section-text">
          ...
          placed by dealers, resellers or distributors. <br /> <br /> <br /> You
          ...
          complete your transactions and contact you as needed. <br /> <br />
          For more detail, please review our Returns Policy.
        </p>

        <h2 className="section-title">SECTION 7 - OPTIONAL TOOLS</h2>
        <p className="section-text">
          We may provide you with access to third-party tools over which we
          neither monitor nor have any control nor input. You acknowledge and
          agree that we provide access to such tools{" "}
          <span className="term-highlight">"as is"</span> and{" "}
          <span className="term-highlight">"as available"</span>
        ...
        <h2 className="section-title">SECTION 8 - THIRD-PARTY LINKS</h2>
        <p className="section-text">
        ...
        <h2 className="section-title">SECTION 10 - PERSONAL INFORMATION</h2>
        <p className="section-text">
        ...
        <h2 className="section-title">SECTION 12 - PROHIBITED USES</h2>
        <p className="section-text">
        ...
        <p className="section-text">
          ...
          <span className="company-name">Sant Designers</span>, our directors,
        ...
        <p className="section-text">
          ...
          <span className="company-name">Sant Designers</span>
        ...
        <h2 className="section-title">SECTION 15 - SEVERABILITY</h2>
        <p className="section-text">
        ...
        <h2 className="section-title">SECTION 16 - TERMINATION</h2>
        <p className="section-text">
        ...
        <h2 className="section-title">SECTION 17 - ENTIRE AGREEMENT</h2>
        <p className="section-text">
        ...
        <h2 className="section-title">SECTION 18 - GOVERNING LAW</h2>
        <p className="section-text">
