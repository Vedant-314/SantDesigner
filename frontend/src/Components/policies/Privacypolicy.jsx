...
const PrivacyPolicy = () => {
  return (
    <div className="terms-container">
      <h1 className="terms-title">PRIVACY STATEMENT</h1>
      ...
      <div className="terms-content">
        ...
        <p className="section-text">
          ...
          <span className="contact-info">
            {" "}
            Chakri Bazaar, Inside Nehru Gate Batala Punjab 143505 , India
          </span>{" "}
        </p>
        ...
        <p className="section-text">
          ...
          complete, your purchase transaction information is not saved. PCI-DSS
        ...
        <p className="section-text">
          ...
          brands like Visa, MasterCard, American Express and Discover. <br />
          <br />
